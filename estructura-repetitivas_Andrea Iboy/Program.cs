namespace estructura_repetitivas_Andrea_Iboy
{
    using System;
    ...
    namespace Estructuras_Repetitivas
    {
        class Ejercicios
        {
            ...
            public static void NumerosPares()
            {
                ...
                Console.WriteLine("Trabajo Supervisado - Andrea Gabriela Iboy Casados");
                Console.WriteLine("_____________________________________________");
                do
                {
                    Console.Write("Ingrese un número (99 para salir): ");
